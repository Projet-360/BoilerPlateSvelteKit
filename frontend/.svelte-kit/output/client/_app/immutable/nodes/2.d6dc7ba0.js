...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$n,depthTest:!1,depthWrite:!1})}function Cl(){return new xi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:jo(),fragmentShader:`
		...
		`,blending:$n,depthTest:!1,depthWrite:!1})}function Ll(){return new xi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:jo(),fragmentShader:`
	...
	`}function G_(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===lo||c===uo,u=c===sr||c===ar;if(l||u)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let d=e.get(a);return t===null&&(t=new wl(i)),d=l?t.fromEquirectangular(a,d):t.fromCubemap(a,d),e.set(a,d),d.texture}else{if(e.has(a))return e.get(a).texture;{const d=a.image;if(l&&d&&d.height>0||u&&d&&r(d)){t===null&&(t=new wl(i));const h=l?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,h),a.addEventListener("dispose",s),h.texture}else return null}}}return a}function r(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function H_(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(n){n.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(n){const r=t(n);return r===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function V_(i,e,t,n){const r={},s=new WeakMap;function o(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const _ in h.attributes)e.remove(h.attributes[_]);for(const _ in h.morphAttributes){const g=h.morphAttributes[_];for(let m=0,f=g.length;m<f;m++)e.remove(g[m])}h.removeEventListener("dispose",o),delete r[h.id];const p=s.get(h);p&&(e.remove(p),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(d,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function c(d){const h=d.attributes;for(const _ in h)e.update(h[_],i.ARRAY_BUFFER);const p=d.morphAttributes;for(const _ in p){const g=p[_];for(let m=0,f=g.length;m<f;m++)e.update(g[m],i.ARRAY_BUFFER)}}function l(d){const h=[],p=d.index,_=d.attributes.position;let g=0;if(p!==null){const x=p.array;g=p.version;for(let v=0,M=x.length;v<M;v+=3){const A=x[v+0],w=x[v+1],y=x[v+2];h.push(A,w,w,y,y,A)}}else if(_!==void 0){const x=_.array;g=_.version;for(let v=0,M=x.length/3-1;v<M;v+=3){const A=v+0,w=v+1,y=v+2;h.push(A,w,w,y,y,A)}}else return;const m=new($u(h)?ef:Qu)(h,1);m.version=g;const f=s.get(d);f&&e.remove(f),s.set(d,m)}function u(d){const h=s.get(d);if(h){const p=d.index;p!==null&&h.version<p.version&&l(d)}else l(d);return s.get(d)}return{get:a,update:c,getWireframeAttribute:u}}function k_(i,e,t,n){const r=n.isWebGL2;let s;function o(h){s=h}let a,c;function l(h){a=h.type,c=h.bytesPerElement}function u(h,p){i.drawElements(s,p,a,h*c),t.update(p,s,1)}function d(h,p,_){if(_===0)return;let g,m;if(r)g=i,m="drawElementsInstanced";else if(g=e.get("ANGLE_instanced_arrays"),m="drawElementsInstancedANGLE",g===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}g[m](s,p,a,h*c,_),t.update(p,s,_)}this.setMode=o,this.setIndex=l,this.render=u,this.renderInstances=d}function W_(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function X_(i,e){return i[0]-e[0]}function q_(i,e){return Math.abs(e[1])-Math.abs(i[1])}function $_(i,e,t){const n={},r=new Float32Array(8),s=new WeakMap,o=new Et,a=[];for(let l=0;l<8;l++)a[l]=[l,0];function c(l,u,d){const h=l.morphTargetInfluences;if(e.isWebGL2===!0){const p=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,_=p!==void 0?p.length:0;let g=s.get(u);if(g===void 0||g.count!==_){let O=function(){k.dispose(),s.delete(u),u.removeEventListener("dispose",O)};g!==void 0&&g.texture.dispose();const x=u.morphAttributes.position!==void 0,v=u.morphAttributes.normal!==void 0,M=u.morphAttributes.color!==void 0,A=u.morphAttributes.position||[],w=u.morphAttributes.normal||[],y=u.morphAttributes.color||[];let D=0;x===!0&&(D=1),v===!0&&(D=2),M===!0&&(D=3);let E=u.attributes.position.count*D,T=1;E>e.maxTextureSize&&(T=Math.ceil(E/e.maxTextureSize),E=e.maxTextureSize);const U=new Float32Array(E*T*4*_),k=new Zu(U,E,T,_);k.type=Xn,k.needsUpdate=!0;const L=D*4;for(let N=0;N<_;N++){const J=A[N],W=w[N],F=y[N],G=E*T*4*N;for(let I=0;I<J.count;I++){const C=I*L;x===!0&&(o.fromBufferAttribute(J,I),U[G+C+0]=o.x,U[G+C+1]=o.y,U[G+C+2]=o.z,U[G+C+3]=0),v===!0&&(o.fromBufferAttribute(W,I),U[G+C+4]=o.x,U[G+C+5]=o.y,U[G+C+6]=o.z,U[G+C+7]=0),M===!0&&(o.fromBufferAttribute(F,I),U[G+C+8]=o.x,U[G+C+9]=o.y,U[G+C+10]=o.z,U[G+C+11]=F.itemSize===4?o.w:1)}}g={count:_,texture:k,size:new Xe(E,T)},s.set(u,g),u.addEventListener("dispose",O)}let m=0;for(let x=0;x<h.length;x++)m+=h[x];const f=u.morphTargetsRelative?1:1-m;d.getUniforms().setValue(i,"morphTargetBaseInfluence",f),d.getUniforms().setValue(i,"morphTargetInfluences",h),d.getUniforms().setValue(i,"morphTargetsTexture",g.texture,t),d.getUniforms().setValue(i,"morphTargetsTextureSize",g.size)}else{const p=h===void 0?0:h.length;let _=n[u.id];if(_===void 0||_.length!==p){_=[];for(let v=0;v<p;v++)_[v]=[v,0];n[u.id]=_}for(let v=0;v<p;v++){const M=_[v];M[0]=v,M[1]=h[v]}_.sort(q_);for(let v=0;v<8;v++)v<p&&_[v][1]?(a[v][0]=_[v][0],a[v][1]=_[v][1]):(a[v][0]=Number.MAX_SAFE_INTEGER,a[v][1]=0);a.sort(X_);const g=u.morphAttributes.position,m=u.morphAttributes.normal;let f=0;for(let v=0;v<8;v++){const M=a[v],A=M[0],w=M[1];A!==Number.MAX_SAFE_INTEGER&&w?(g&&u.getAttribute("morphTarget"+v)!==g[A]&&u.setAttribute("morphTarget"+v,g[A]),m&&u.getAttribute("morphNormal"+v)!==m[A]&&u.setAttribute("morphNormal"+v,m[A]),r[v]=w,f+=w):(g&&u.hasAttribute("morphTarget"+v)===!0&&u.deleteAttribute("morphTarget"+v),m&&u.hasAttribute("morphNormal"+v)===!0&&u.deleteAttribute("morphNormal"+v),r[v]=0)}const x=u.morphTargetsRelative?1:1-f;d.getUniforms().setValue(i,"morphTargetBaseInfluence",x),d.getUniforms().setValue(i,"morphTargetInfluences",r)}}return{update:c}}function Y_(i,e,t,n){let r=new WeakMap;function s(c){const l=n.render.frame,u=c.geometry,d=e.get(c,u);if(r.get(d)!==l&&(e.update(d),r.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const h=c.skeleton;r.get(h)!==l&&(h.update(),r.set(h,l))}return d}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}const of=new Bt,cf=new Zu,lf=new Dd,uf=new rf,Pl=[],Dl=[],Ul=new Float32Array(16),Il=new Float32Array(9),Nl=new Float32Array(4);function _r(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Pl[r];if(s===void 0&&(s=new Float32Array(r),Pl[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function ht(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function dt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function aa(i,e){let t=Dl[e];t===void 0&&(t=new Int32Array(e),Dl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function K_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Z_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2fv(this.addr,e),dt(t,e)}}function j_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ht(t,e))return;i.uniform3fv(this.addr,e),dt(t,e)}}function J_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4fv(this.addr,e),dt(t,e)}}function Q_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),dt(t,e)}else{if(ht(t,n))return;Nl.set(n),i.uniformMatrix2fv(this.addr,!1,Nl),dt(t,n)}}function eg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),dt(t,e)}else{if(ht(t,n))return;Il.set(n),i.uniformMatrix3fv(this.addr,!1,Il),dt(t,n)}}function tg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ht(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),dt(t,e)}else{if(ht(t,n))return;Ul.set(n),i.uniformMatrix4fv(this.addr,!1,Ul),dt(t,n)}}function ng(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function ig(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2iv(this.addr,e),dt(t,e)}}function rg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ht(t,e))return;i.uniform3iv(this.addr,e),dt(t,e)}}function sg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4iv(this.addr,e),dt(t,e)}}function ag(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function og(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ht(t,e))return;i.uniform2uiv(this.addr,e),dt(t,e)}}function cg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ht(t,e))return;i.uniform3uiv(this.addr,e),dt(t,e)}}function lg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ht(t,e))return;i.uniform4uiv(this.addr,e),dt(t,e)}}function ug(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2D(e||of,r)}function fg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||lf,r)}function hg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||uf,r)}function dg(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||cf,r)}function pg(i){switch(i){case 5126:return K_;case 35664:return Z_;case 35665:return j_;case 35666:return J_;case 35674:return Q_;case 35675:return eg;case 35676:return tg;case 5124:case 35670:return ng;case 35667:case 35671:return ig;case 35668:case 35672:return rg;case 35669:case 35673:return sg;case 5125:return ag;case 36294:return og;case 36295:return cg;case 36296:return lg;case 35678:case 36198:case 36298:case 36306:case 35682:return ug;case 35679:case 36299:case 36307:return fg;case 35680:case 36300:case 36308:case 36293:return hg;case 36289:case 36303:case 36311:case 36292:return dg}}function mg(i,e){i.uniform1fv(this.addr,e)}function _g(i,e){const t=_r(e,this.size,2);i.uniform2fv(this.addr,t)}function gg(i,e){const t=_r(e,this.size,3);i.uniform3fv(this.addr,t)}function vg(i,e){const t=_r(e,this.size,4);i.uniform4fv(this.addr,t)}function xg(i,e){const t=_r(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Eg(i,e){const t=_r(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Sg(i,e){const t=_r(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Mg(i,e){i.uniform1iv(this.addr,e)}function yg(i,e){i.uniform2iv(this.addr,e)}function Tg(i,e){i.uniform3iv(this.addr,e)}function Ag(i,e){i.uniform4iv(this.addr,e)}function bg(i,e){i.uniform1uiv(this.addr,e)}function wg(i,e){i.uniform2uiv(this.addr,e)}function Rg(i,e){i.uniform3uiv(this.addr,e)}function Cg(i,e){i.uniform4uiv(this.addr,e)}function Lg(i,e,t){const n=this.cache,r=e.length,s=aa(t,r);ht(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||of,s[o])}function Pg(i,e,t){const n=this.cache,r=e.length,s=aa(t,r);ht(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||lf,s[o])}function Dg(i,e,t){const n=this.cache,r=e.length,s=aa(t,r);ht(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||uf,s[o])}function Ug(i,e,t){const n=this.cache,r=e.length,s=aa(t,r);ht(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||cf,s[o])}function Ig(i){switch(i){case 5126:return mg;case 35664:return _g;case 35665:return gg;case 35666:return vg;case 35674:return xg;case 35675:return Eg;case 35676:return Sg;case 5124:case 35670:return Mg;case 35667:case 35671:return yg;case 35668:case 35672:return Tg;case 35669:case 35673:return Ag;case 5125:return bg;case 36294:return wg;case 36295:return Rg;case 36296:return Cg;case 35678:case 36198:case 36298:case 36306:case 35682:return Lg;case 35679:case 36299:case 36307:return Pg;case 35680:case 36300:case 36308:case 36293:return Dg;case 36289:case 36303:case 36311:case 36292:return Ug}}class Ng{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.setValue=pg(t.type)}}class Og{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.size=t.size,this.setValue=Ig(t.type)}}class Fg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Qa=/(\w+)(\])?(\[|\.)?/g;function Ol(i,e){i.seq.push(e),i.map[e.id]=e}function Bg(i,e,t){const n=i.name,r=n.length;for(Qa.lastIndex=0;;){const s=Qa.exec(n),o=Qa.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){Ol(t,l===void 0?new Ng(a,i,e):new Og(a,i,e));break}else{let d=t.map[a];d===void 0&&(d=new Fg(a),Ol(t,d)),t=d}}}class Ls{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Bg(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Fl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}let zg=0;function Gg(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Hg(i){switch(i){case _n:return["Linear","( value )"];case et:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),["Linear","( value )"]}}function Bl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Gg(i.getShaderSource(e),o)}else return r}function Vg(i,e){const t=Hg(e);return"vec4 "+i+"( vec4 value ) { return LinearTo"+t[0]+t[1]+"; }"}function kg(i,e){let t;switch(e){case $h:t="Linear";break;case Yh:t="Reinhard";break;case Kh:t="OptimizedCineon";break;case Zh:t="ACESFilmic";break;case jh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Wg(i){return[i.extensionDerivatives||i.envMapCubeUVHeight||i.bumpMap||i.normalMapTangentSpace||i.clearcoatNormalMap||i.flatShading||i.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(i.extensionFragDepth||i.logarithmicDepthBuffer)&&i.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",i.extensionDrawBuffers&&i.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(i.extensionShaderTextureLOD||i.envMap||i.transmission)&&i.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Rr).join(`
`)}function Xg(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function qg(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Rr(i){return i!==""}function zl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Gl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const $g=/^[ \t]*#include +<([\w\d./]+)>/gm;function go(i){return i.replace($g,Kg)}const Yg=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Kg(i,e){let t=Ue[e];if(t===void 0){const n=Yg.get(e);if(n!==void 0)t=Ue[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return go(t)}const Zg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Hl(i){return i.replace(Zg,jg)}function jg(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Vl(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Jg(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Nu?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Ah?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Cn&&(e="SHADOWMAP_TYPE_VSM"),e}function Qg(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case sr:case ar:e="ENVMAP_TYPE_CUBE";break;case na:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ev(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ar:e="ENVMAP_MODE_REFRACTION";break}return e}function tv(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Bu:e="ENVMAP_BLENDING_MULTIPLY";break;case Xh:e="ENVMAP_BLENDING_MIX";break;case qh:e="ENVMAP_BLENDING_ADD";break}return e}function nv(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function iv(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=Jg(t),l=Qg(t),u=ev(t),d=tv(t),h=nv(t),p=t.isWebGL2?"":Wg(t),_=Xg(s),g=r.createProgram();let m,f,x=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		`),c=je(A,"INPUT",{id:!0,name:!0,type:!0,autocomplete:!0}),A.forEach(be),l=gt(v),u=je(v,"BUTTON",{type:!0});var w=At(u);d=pn(w,"Envoyer"),w.forEach(be),v.forEach(be),h=gt(x),p=je(x,"UL",{});var y=At(p);for(let D=0;D<f.length;D+=1)f[D].l(y);y.forEach(be),this.h()},h(){we(r,"id","nameInput"),we(r,"name","name"),we(r,"type","text"),we(r,"autocomplete","name"),we(t,"for","nameInput"),we(c,"id","messageInput"),we(c,"name","message"),we(c,"type","text"),we(c,"autocomplete","on"),we(o,"for","messageInput"),we(u,"type","submit")},m(x,v){ke(x,e,v),Qe(e,t),Qe(t,n),Qe(t,r),ns(r,i[3]),Qe(e,s),Qe(e,o),Qe(o,a),Qe(o,c),ns(c,i[4]),Qe(e,l),Qe(e,u),Qe(u,d),ke(x,h,v),ke(x,p,v);for(let M=0;M<f.length;M+=1)f[M]&&f[M].m(p,null);_||(g=[Lr(r,"input",i[6]),Lr(c,"input",i[7]),Lr(e,"submit",hh(i[1]))],_=!0)},p(x,[v]){if(v&8&&r.value!==x[3]&&ns(r,x[3]),v&16&&c.value!==x[4]&&ns(c,x[4]),v&37){m=x[5];let M;for(M=0;M<m.length;M+=1){const A=nu(x,m,M);f[M]?f[M].p(A,v):(f[M]=iu(A),f[M].c(),f[M].m(p,null))}for(;M<f.length;M+=1)f[M].d(1);f.length=m.length}},i:ln,o:ln,d(x){x&&be(e),x&&be(h),x&&be(p),dh(f,x),_=!1,Du(g)}}}function L0(i,e,t){let n;Uu(i,Iu,g=>t(11,n=g));let r=null,s="",o="",a=[];Vo(async()=>{t(5,a=await Rs()),io.on("updateGreetings",async()=>{console.log("Received updateGreetings event from server"),t(5,a=await Rs())})});function c(g){t(3,s=g.name),t(4,o=g.message),r=g._id}async function l(){console.log("Sending greeting"),await w0(s,o,r,n)&&(t(3,s=""),t(4,o=""),r=null,io.emit("greetingSent"),t(5,a=await Rs()))}async function u(g){console.log(`Deleting greeting with id ${g}`),await R0(g)&&(io.emit("greetingDeleted"),t(5,a=await Rs()))}function d(){s=this.value,t(3,s)}function h(){o=this.value,t(4,o)}return[c,l,u,s,o,a,d,h,g=>c(g),g=>u(g._id)]}class P0 extends yi{constructor(e){super(),Ti(this,e,L0,C0,Ai,{prepareUpdate:0,handleSendGreeting:1,handleDeleteGreeting:2})}get prepareUpdate(){return this.$$.ctx[0]}get handleSendGreeting(){return this.$$.ctx[1]}get handleDeleteGreeting(){return this.$$.ctx[2]}}/*!
 * @splidejs/splide-extension-auto-scroll
 * Version  : 0.5.3
 * License  : MIT
 * Copyright: 2022 Naotoshi Fujita
 */function D0(i){i.length=0}function rc(i,e,t){return Array.prototype.slice.call(i,e,t)}function ca(i){return i.bind.apply(i,[null].concat(rc(arguments,1)))}function ru(i){return requestAnimationFrame(i)}function sc(i,e){return typeof e===i}var bf=Array.isArray;ca(sc,"function");ca(sc,"string");ca(sc,"undefined");function wf(i){return bf(i)?i:[i]}function su(i,e){wf(i).forEach(e)}var U0=Object.keys;function I0(i,e,t){if(i){var n=U0(i);n=t?n.reverse():n;for(var r=0;r<n.length;r++){var s=n[r];if(s!=="__proto__"&&e(i[s],s)===!1)break}}return i}function N0(i){return rc(arguments,1).forEach(function(e){I0(e,function(t,n){i[n]=e[n]})}),i}var O0=Math.min;function F0(){var i=[];function e(o,a,c,l){r(o,a,function(u,d,h){var p="addEventListener"in u,_=p?u.removeEventListener.bind(u,d,c,l):u.removeListener.bind(u,c);p?u.addEventListener(d,c,l):u.addListener(c),i.push([u,d,h,c,_])})}function t(o,a,c){r(o,a,function(l,u,d){i=i.filter(function(h){return h[0]===l&&h[1]===u&&h[2]===d&&(!c||h[3]===c)?(h[4](),!1):!0})})}function n(o,a,c){var l,u=!0;return typeof CustomEvent=="function"?l=new CustomEvent(a,{bubbles:u,detail:c}):(l=document.createEvent("CustomEvent"),l.initCustomEvent(a,u,!1,c)),o.dispatchEvent(l),l}function r(o,a,c){su(o,function(l){l&&su(a,function(u){u.split(" ").forEach(function(d){var h=d.split(".");c(l,h[0],h[1])})})})}function s(){i.forEach(function(o){o[4]()}),D0(i)}return{bind:e,unbind:t,dispatch:n,destroy:s}}var au="move",ou="moved",B0="updated",cu="drag",z0="dragged",lu="scroll",uu="scrolled",G0="destroy";function H0(i){var e=i?i.event.bus:document.createDocumentFragment(),t=F0();function n(s,o){t.bind(e,wf(s).join(" "),function(a){o.apply(o,bf(a.detail)?a.detail:[])})}function r(s){t.dispatch(e,s,rc(arguments,1))}return i&&i.event.on(G0,t.destroy),N0(t,{bus:e,on:n,off:ca(t.unbind,e),emit:r})}function Rf(i,e,t,n){var r=Date.now,s,o=0,a,c=!0,l=0;function u(){if(!c){if(o=i?O0((r()-s)/i,1):1,t&&t(o),o>=1&&(e(),s=r(),n&&++l>=n))return h();ru(u)}}function d(f){!f&&_(),s=r()-(f?o*i:0),c=!1,ru(u)}function h(){c=!0}function p(){s=r(),o=0,t&&t(o)}function _(){a&&cancelAnimationFrame(a),o=0,a=0,c=!0}function g(f){i=f}function m(){return c}return{start:d,rewind:p,pause:h,cancel:_,set:g,isPaused:m}}function V0(i,e){var t;function n(){t||(t=Rf(e||0,function(){i(),t=null},null,1),t.start())}return n}var k0="is-active",W0="slide",X0="fade";function Cf(i,e,t){return Array.prototype.slice.call(i,e,t)}function ac(i){return i.bind(null,...Cf(arguments,1))}function la(i,e){return typeof e===i}function To(i){return!Lf(i)&&la("object",i)}const q0=Array.isArray;ac(la,"function");ac(la,"string");const $0=ac(la,"undefined");function Lf(i){return i===null}function Y0(i){return q0(i)?i:[i]}function ks(i,e){Y0(i).forEach(e)}function K0(i,e,t){i&&ks(e,n=>{n&&i.classList[t?"add":"remove"](n)})}const Z0=Object.keys;function Pf(i,e,t){if(i){let n=Z0(i);n=t?n.reverse():n;for(let r=0;r<n.length;r++){const s=n[r];if(s!=="__proto__"&&e(i[s],s)===!1)break}}return i}function fu(i){return Cf(arguments,1).forEach(e=>{Pf(e,(t,n)=>{i[n]=e[n]})}),i}function j0(i,e){ks(i,t=>{ks(e,n=>{t&&t.removeAttribute(n)})})}function Df(i,e,t){To(e)?Pf(e,(n,r)=>{Df(i,r,n)}):ks(i,n=>{Lf(t)||t===""?j0(n,e):n.setAttribute(e,String(t))})}const{min:hu,max:du,floor:GE,ceil:HE,abs:VE}=Math;function J0(i,e,t){const n=hu(e,t),r=du(e,t);return hu(du(n,i),r)}const Q0={speed:1,autoStart:!0,pauseOnHover:!0,pauseOnFocus:!0},ex={startScroll:"Start auto scroll",pauseScroll:"Pause auto scroll"};function tx(i,e,t){const{on:n,off:r,bind:s,unbind:o}=H0(i),{translate:a,getPosition:c,toIndex:l,getLimit:u}=e.Move,{setIndex:d,getIndex:h}=e.Controller,{orient:p}=e.Direction,{toggle:_}=e.Elements,{Live:g}=e,{root:m}=i,f=V0(e.Arrows.update,500);let x={},v,M,A,w,y,D;function E(){const{autoScroll:Q}=t;x=fu({},Q0,To(Q)?Q:{})}function T(){i.is(X0)||!v&&t.autoScroll!==!1&&(v=Rf(0,F),k(),O())}function U(){v&&(v.cancel(),v=null,D=void 0,r([au,cu,lu,ou,uu]),o(m,"mouseenter mouseleave focusin focusout"),o(_,"click"))}function k(){x.pauseOnHover&&s(m,"mouseenter mouseleave",Q=>{A=Q.type==="mouseenter",W()}),x.pauseOnFocus&&s(m,"focusin focusout",Q=>{w=Q.type==="focusin",W()}),x.useToggleButton&&s(_,"click",()=>{M?N():J()}),n(B0,L),n([au,cu,lu],()=>{y=!0,J(!1)}),n([ou,z0,uu],()=>{y=!1,W()})}function L(){const{autoScroll:Q}=t;Q!==!1?(x=fu({},x,To(Q)?Q:{}),T()):U(),v&&!$0(D)&&a(D)}function O(){x.autoStart&&(document.readyState==="complete"?N():s(window,"load",N))}function N(){V()&&(v.start(!0),g.disable(!0),w=A=M=!1,C())}function J(Q=!0){M||(M=Q,C(),V()||(v.pause(),g.disable(!1)))}function W(){M||(A||w||y?J(!1):N())}function F(){const Q=c(),ee=G(Q);Q!==ee?(a(ee),I(D=c())):(J(!1),x.rewind&&i.go(x.speed>0?0:e.Controller.getEnd())),f()}function G(Q){const ee=x.speed||1;return Q+=p(ee),i.is(W0)&&(Q=J0(Q,u(!1),u(!0))),Q}function I(Q){const{length:ee}=i,ce=(l(Q)+ee)%ee;ce!==h()&&(d(ce),e.Slides.update(),e.Pagination.update(),t.lazyLoad==="nearby"&&e.LazyLoad.check())}function C(){if(_){const Q=M?"startScroll":"pauseScroll";K0(_,k0,!M),Df(_,"aria-label",t.i18n[Q]||ex[Q])}}function V(){return!v||v.isPaused()}return{setup:E,mount:T,destroy:U,play:N,pause:J,isPaused:V}}function lr(...i){return i.filter(Boolean).join(" ")}function nx(i,e){if(i){const t=Object.keys(i);for(let n=0;n<t.length;n++){const r=t[n];if(r!=="__proto__"&&e(i[r],r)===!1)break}}return i}function pu(i){var t;const e=(t=i.Components.Elements)==null?void 0:t.list.children;return e&&Array.prototype.slice.call(e)||[]}function Ws(i){return i!==null&&typeof i=="object"}function Ao(i,e){if(Array.isArray(i)&&Array.isArray(e))return i.length===e.length&&!i.some((t,n)=>!Ao(t,e[n]));if(Ws(i)&&Ws(e)){const t=Object.keys(i),n=Object.keys(e);return t.length===n.length&&!t.some(r=>!Object.prototype.hasOwnProperty.call(e,r)||!Ao(i[r],e[r]))}return i===e}function ix(i,e){return i.length===e.length&&!i.some((t,n)=>t!==e[n])}function bo(i,e){const t=i;return nx(e,(n,r)=>{Array.isArray(n)?t[r]=n.slice():Ws(n)?t[r]=bo(Ws(t[r])?t[r]:{},n):t[r]=n}),t}function mu(i,e){for(var t=0;t<e.length;t++){var n=e[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(i,n.key,n)}}function rx(i,e,t){return e&&mu(i.prototype,e),t&&mu(i,t),Object.defineProperty(i,"prototype",{writable:!1}),i}/*!
 * Splide.js
 * Version  : 4.1.4
 * License  : MIT
 * Copyright: 2022 Naotoshi Fujita
 */var _u="(prefers-reduced-motion: reduce)",ji=1,sx=2,ur=3,vr=4,qr=5,Ns=6,Xs=7,ax={CREATED:ji,MOUNTED:sx,IDLE:ur,MOVING:vr,SCROLLING:qr,DRAGGING:Ns,DESTROYED:Xs};function Bn(i){i.length=0}function Qn(i,e,t){return Array.prototype.slice.call(i,e,t)}function $e(i){return i.bind.apply(i,[null].concat(Qn(arguments,1)))}var Uf=setTimeout,wo=function(){};function gu(i){return requestAnimationFrame(i)}function ua(i,e){return typeof e===i}function Or(i){return!cc(i)&&ua("object",i)}var oc=Array.isArray,If=$e(ua,"function"),jn=$e(ua,"string"),$r=$e(ua,"undefined");function cc(i){return i===null}function Nf(i){try{return i instanceof(i.ownerDocument.defaultView||window).HTMLElement}catch{return!1}}function Yr(i){return oc(i)?i:[i]}function $t(i,e){Yr(i).forEach(e)}function lc(i,e){return i.indexOf(e)>-1}function Os(i,e){return i.push.apply(i,Yr(e)),i}function In(i,e,t){i&&$t(e,function(n){n&&i.classList[t?"add":"remove"](n)})}function vn(i,e){In(i,jn(e)?e.split(" "):e,!0)}function Kr(i,e){$t(e,i.appendChild.bind(i))}function uc(i,e){$t(i,function(t){var n=(e||t).parentNode;n&&n.insertBefore(t,e)})}function Fr(i,e){return Nf(i)&&(i.msMatchesSelector||i.matches).call(i,e)}function Of(i,e){var t=i?Qn(i.children):[];return e?t.filter(function(n){return Fr(n,e)}):t}function Zr(i,e){return e?Of(i,e)[0]:i.firstElementChild}var Br=Object.keys;function gi(i,e,t){return i&&(t?Br(i).reverse():Br(i)).forEach(function(n){n!=="__proto__"&&e(i[n],n)}),i}function zr(i){return Qn(arguments,1).forEach(function(e){gi(e,function(t,n){i[n]=e[n]})}),i}function qn(i){return Qn(arguments,1).forEach(function(e){gi(e,function(t,n){oc(t)?i[n]=t.slice():Or(t)?i[n]=qn({},Or(i[n])?i[n]:{},t):i[n]=t})}),i}function vu(i,e){$t(e||Br(i),function(t){delete i[t]})}function xn(i,e){$t(i,function(t){$t(e,function(n){t&&t.removeAttribute(n)})})}function Le(i,e,t){Or(e)?gi(e,function(n,r){Le(i,r,n)}):$t(i,function(n){cc(t)||t===""?xn(n,e):n.setAttribute(e,String(t))})}function tr(i,e,t){var n=document.createElement(i);return e&&(jn(e)?vn(n,e):Le(n,e)),t&&Kr(t,n),n}function sn(i,e,t){if($r(t))return getComputedStyle(i)[e];cc(t)||(i.style[e]=""+t)}function Gr(i,e){sn(i,"display",e)}function Ff(i){i.setActive&&i.setActive()||i.focus({preventScroll:!0})}function cn(i,e){return i.getAttribute(e)}function xu(i,e){return i&&i.classList.contains(e)}function Xt(i){return i.getBoundingClientRect()}function Ei(i){$t(i,function(e){e&&e.parentNode&&e.parentNode.removeChild(e)})}function Bf(i){return Zr(new DOMParser().parseFromString(i,"text/html").body)}function Ln(i,e){i.preventDefault(),e&&(i.stopPropagation(),i.stopImmediatePropagation())}function zf(i,e){return i&&i.querySelector(e)}function fc(i,e){return e?Qn(i.querySelectorAll(e)):[]}function Nn(i,e){In(i,e,!1)}function Ro(i){return i.timeStamp}function ci(i){return jn(i)?i:i?i+"px":""}var jr="splide",hc="data-"+jr;function Dr(i,e){if(!i)throw new Error("["+jr+"] "+(e||""))}var Jn=Math.min,qs=Math.max,$s=Math.floor,Hr=Math.ceil,Ut=Math.abs;function Gf(i,e,t){return Ut(i-e)<t}function Fs(i,e,t,n){var r=Jn(e,t),s=qs(e,t);return n?r<i&&i<s:r<=i&&i<=s}function Yi(i,e,t){var n=Jn(e,t),r=qs(e,t);return Jn(qs(n,i),r)}function Co(i){return+(i>0)-+(i<0)}function Lo(i,e){return $t(e,function(t){i=i.replace("%s",""+t)}),i}function dc(i){return i<10?"0"+i:""+i}var Eu={};function ox(i){return""+i+dc(Eu[i]=(Eu[i]||0)+1)}function Hf(){var i=[];function e(o,a,c,l){r(o,a,function(u,d,h){var p="addEventListener"in u,_=p?u.removeEventListener.bind(u,d,c,l):u.removeListener.bind(u,c);p?u.addEventListener(d,c,l):u.addListener(c),i.push([u,d,h,c,_])})}function t(o,a,c){r(o,a,function(l,u,d){i=i.filter(function(h){return h[0]===l&&h[1]===u&&h[2]===d&&(!c||h[3]===c)?(h[4](),!1):!0})})}function n(o,a,c){var l,u=!0;return typeof CustomEvent=="function"?l=new CustomEvent(a,{bubbles:u,detail:c}):(l=document.createEvent("CustomEvent"),l.initCustomEvent(a,u,!1,c)),o.dispatchEvent(l),l}function r(o,a,c){$t(o,function(l){l&&$t(a,function(u){u.split(" ").forEach(function(d){var h=d.split(".");c(l,h[0],h[1])})})})}function s(){i.forEach(function(o){o[4]()}),Bn(i)}return{bind:e,unbind:t,dispatch:n,destroy:s}}var ei="mounted",Su="ready",En="move",Si="moved",Ys="click",Po="active",Do="inactive",Uo="visible",Io="hidden",ut="refresh",bt="updated",fr="resize",fa="resized",Vf="drag",kf="dragging",Wf="dragged",ha="scroll",wi="scrolled",cx="overflow",pc="destroy",No="arrows:mounted",Oo="arrows:updated",Fo="pagination:mounted",Bo="pagination:updated",Ks="navigation:mounted",mc="autoplay:play",zo="autoplay:playing",_c="autoplay:pause",Zs="lazyload:loaded",Xf="sk",qf="sh",js="ei";function nt(i){var e=i?i.event.bus:document.createDocumentFragment(),t=Hf();function n(s,o){t.bind(e,Yr(s).join(" "),function(a){o.apply(o,oc(a.detail)?a.detail:[])})}function r(s){t.dispatch(e,s,Qn(arguments,1))}return i&&i.event.on(pc,t.destroy),zr(t,{bus:e,on:n,off:$e(t.unbind,e),emit:r})}function da(i,e,t,n){var r=Date.now,s,o=0,a,c=!0,l=0;function u(){if(!c){if(o=i?Jn((r()-s)/i,1):1,t&&t(o),o>=1&&(e(),s=r(),n&&++l>=n))return h();a=gu(u)}}function d(f){f||_(),s=r()-(f?o*i:0),c=!1,a=gu(u)}function h(){c=!0}function p(){s=r(),o=0,t&&t(o)}function _(){a&&cancelAnimationFrame(a),o=0,a=0,c=!0}function g(f){i=f}function m(){return c}return{start:d,rewind:p,pause:h,cancel:_,set:g,isPaused:m}}function lx(i){var e=i;function t(r){e=r}function n(r){return lc(Yr(r),e)}return{set:t,is:n}}function ux(i,e){var t=da(e||0,i,null,1);return function(){t.isPaused()&&t.start()}}function fx(i,e,t){var n=i.state,r=t.breakpoints||{},s=t.reducedMotion||{},o=Hf(),a=[];function c(){var _=t.mediaQuery==="min";Br(r).sort(function(g,m){return _?+g-+m:+m-+g}).forEach(function(g){u(r[g],"("+(_?"min":"max")+"-width:"+g+"px)")}),u(s,_u),d()}function l(_){_&&o.destroy()}function u(_,g){var m=matchMedia(g);o.bind(m,"change",d),a.push([_,m])}function d(){var _=n.is(Xs),g=t.direction,m=a.reduce(function(f,x){return qn(f,x[1].matches?x[0]:{})},{});vu(t),p(m),t.destroy?i.destroy(t.destroy==="completely"):_?(l(!0),i.mount()):g!==t.direction&&i.refresh()}function h(_){matchMedia(_u).matches&&(_?qn(t,s):vu(t,Br(s)))}function p(_,g,m){qn(t,_),g&&qn(Object.getPrototypeOf(t),_),(m||!n.is(ji))&&i.emit(bt,t)}return{setup:c,destroy:l,reduce:h,set:p}}var pa="Arrow",ma=pa+"Left",_a=pa+"Right",$f=pa+"Up",Yf=pa+"Down",Mu="rtl",ga="ttb",ro={width:["height"],left:["top","right"],right:["bottom","left"],x:["y"],X:["Y"],Y:["X"],ArrowLeft:[$f,_a],ArrowRight:[Yf,ma]};function hx(i,e,t){function n(s,o,a){a=a||t.direction;var c=a===Mu&&!o?1:a===ga?0:-1;return ro[s]&&ro[s][c]||s.replace(/width|left|right/i,function(l,u){var d=ro[l.toLowerCase()][c]||l;return u>0?d.charAt(0).toUpperCase()+d.slice(1):d})}function r(s){return s*(t.direction===Mu?1:-1)}return{resolve:n,orient:r}}var On="role",nr="tabindex",dx="disabled",un="aria-",Jr=un+"controls",Kf=un+"current",yu=un+"selected",qt=un+"label",gc=un+"labelledby",Zf=un+"hidden",vc=un+"orientation",Vr=un+"roledescription",Tu=un+"live",Au=un+"busy",bu=un+"atomic",xc=[On,nr,dx,Jr,Kf,qt,gc,Zf,vc,Vr],Sn=jr+"__",ti="is-",so=jr,wu=Sn+"track",px=Sn+"list",va=Sn+"slide",jf=va+"--clone",mx=va+"__container",Ec=Sn+"arrows",xa=Sn+"arrow",Jf=xa+"--prev",Qf=xa+"--next",Ea=Sn+"pagination",eh=Ea+"__page",_x=Sn+"progress",gx=_x+"__bar",vx=Sn+"toggle",xx=Sn+"spinner",Ex=Sn+"sr",Sx=ti+"initialized",Mi=ti+"active",th=ti+"prev",nh=ti+"next",Go=ti+"visible",Ho=ti+"loading",ih=ti+"focus-in",rh=ti+"overflow",Mx=[Mi,Go,th,nh,Ho,ih,rh],yx={slide:va,clone:jf,arrows:Ec,arrow:xa,prev:Jf,next:Qf,pagination:Ea,page:eh,spinner:xx};function Tx(i,e){if(If(i.closest))return i.closest(e);for(var t=i;t&&t.nodeType===1&&!Fr(t,e);)t=t.parentElement;return t}var Ax=5,Ru=200,sh="touchstart mousedown",ao="touchmove mousemove",oo="touchend touchcancel mouseup click";function bx(i,e,t){var n=nt(i),r=n.on,s=n.bind,o=i.root,a=t.i18n,c={},l=[],u=[],d=[],h,p,_;function g(){v(),M(),x()}function m(){r(ut,f),r(ut,g),r(bt,x),s(document,sh+" keydown",function(y){_=y.type==="keydown"},{capture:!0}),s(o,"focusin",function(){In(o,ih,!!_)})}function f(y){var D=xc.concat("style");Bn(l),Nn(o,u),Nn(h,d),xn([h,p],D),xn(o,y?D:["style",Vr])}function x(){Nn(o,u),Nn(h,d),u=w(so),d=w(wu),vn(o,u),vn(h,d),Le(o,qt,t.label),Le(o,gc,t.labelledby)}function v(){h=A("."+wu),p=Zr(h,"."+px),Dr(h&&p,"A track/list element is missing."),Os(l,Of(p,"."+va+":not(."+jf+")")),gi({arrows:Ec,pagination:Ea,prev:Jf,next:Qf,bar:gx,toggle:vx},function(y,D){c[D]=A("."+y)}),zr(c,{root:o,track:h,list:p,slides:l})}function M(){var y=o.id||ox(jr),D=t.role;o.id=y,h.id=h.id||y+"-track",p.id=p.id||y+"-list",!cn(o,On)&&o.tagName!=="SECTION"&&D&&Le(o,On,D),Le(o,Vr,a.carousel),Le(p,On,"presentation")}function A(y){var D=zf(o,y);return D&&Tx(D,"."+so)===o?D:void 0}function w(y){return[y+"--"+t.type,y+"--"+t.direction,t.drag&&y+"--draggable",t.isNavigation&&y+"--nav",y===so&&Mi]}return zr(c,{setup:g,mount:m,destroy:f})}var hr="slide",xr="loop",Qr="fade";function wx(i,e,t,n){var r=nt(i),s=r.on,o=r.emit,a=r.bind,c=i.Components,l=i.root,u=i.options,d=u.isNavigation,h=u.updateOnMove,p=u.i18n,_=u.pagination,g=u.slideFocus,m=c.Direction.resolve,f=cn(n,"style"),x=cn(n,qt),v=t>-1,M=Zr(n,"."+mx),A;function w(){v||(n.id=l.id+"-slide"+dc(e+1),Le(n,On,_?"tabpanel":"group"),Le(n,Vr,p.slide),Le(n,qt,x||Lo(p.slideLabel,[e+1,i.length]))),y()}function y(){a(n,"click",$e(o,Ys,F)),a(n,"keydown",$e(o,Xf,F)),s([Si,qf,wi],U),s(Ks,E),h&&s(En,T)}function D(){A=!0,r.destroy(),Nn(n,Mx),xn(n,xc),Le(n,"style",f),Le(n,qt,x||"")}function E(){var G=i.splides.map(function(I){var C=I.splide.Components.Slides.getAt(e);return C?C.slide.id:""}).join(" ");Le(n,qt,Lo(p.slideX,(v?t:e)+1)),Le(n,Jr,G),Le(n,On,g?"button":""),g&&xn(n,Vr)}function T(){A||U()}function U(){if(!A){var G=i.index;k(),L(),In(n,th,e===G-1),In(n,nh,e===G+1)}}function k(){var G=N();G!==xu(n,Mi)&&(In(n,Mi,G),Le(n,Kf,d&&G||""),o(G?Po:Do,F))}function L(){var G=J(),I=!G&&(!N()||v);if(i.state.is([vr,qr])||Le(n,Zf,I||""),Le(fc(n,u.focusableNodes||""),nr,I?-1:""),g&&Le(n,nr,I?-1:0),G!==xu(n,Go)&&(In(n,Go,G),o(G?Uo:Io,F)),!G&&document.activeElement===n){var C=c.Slides.getAt(i.index);C&&Ff(C.slide)}}function O(G,I,C){sn(C&&M||n,G,I)}function N(){var G=i.index;return G===e||u.cloneStatus&&G===t}function J(){if(i.is(Qr))return N();var G=Xt(c.Elements.track),I=Xt(n),C=m("left",!0),V=m("right",!0);return $s(G[C])<=Hr(I[C])&&$s(I[V])<=Hr(G[V])}function W(G,I){var C=Ut(G-e);return!v&&(u.rewind||i.is(xr))&&(C=Jn(C,i.length-C)),C<=I}var F={index:e,slideIndex:t,slide:n,container:M,isClone:v,mount:w,destroy:D,update:U,style:O,isWithin:W};return F}function Rx(i,e,t){var n=nt(i),r=n.on,s=n.emit,o=n.bind,a=e.Elements,c=a.slides,l=a.list,u=[];function d(){h(),r(ut,p),r(ut,h)}function h(){c.forEach(function(U,k){g(U,k,-1)})}function p(){A(function(U){U.destroy()}),Bn(u)}function _(){A(function(U){U.update()})}function g(U,k,L){var O=wx(i,k,L,U);O.mount(),u.push(O),u.sort(function(N,J){return N.index-J.index})}function m(U){return U?w(function(k){return!k.isClone}):u}function f(U){var k=e.Controller,L=k.toIndex(U),O=k.hasFocus()?1:t.perPage;return w(function(N){return Fs(N.index,L,L+O-1)})}function x(U){return w(U)[0]}function v(U,k){$t(U,function(L){if(jn(L)&&(L=Bf(L)),Nf(L)){var O=c[k];O?uc(L,O):Kr(l,L),vn(L,t.classes.slide),D(L,$e(s,fr))}}),s(ut)}function M(U){Ei(w(U).map(function(k){return k.slide})),s(ut)}function A(U,k){m(k).forEach(U)}function w(U){return u.filter(If(U)?U:function(k){return jn(U)?Fr(k.slide,U):lc(Yr(U),k.index)})}function y(U,k,L){A(function(O){O.style(U,k,L)})}function D(U,k){var L=fc(U,"img"),O=L.length;O?L.forEach(function(N){o(N,"load error",function(){--O||k()})}):k()}function E(U){return U?c.length:u.length}function T(){return u.length>t.perPage}return{mount:d,destroy:p,update:_,register:g,get:m,getIn:f,getAt:x,add:v,remove:M,forEach:A,filter:w,style:y,getLength:E,isEnough:T}}function Cx(i,e,t){var n=nt(i),r=n.on,s=n.bind,o=n.emit,a=e.Slides,c=e.Direction.resolve,l=e.Elements,u=l.root,d=l.track,h=l.list,p=a.getAt,_=a.style,g,m,f;function x(){v(),s(window,"resize load",ux($e(o,fr))),r([bt,ut],v),r(fr,M)}function v(){g=t.direction===ga,sn(u,"maxWidth",ci(t.width)),sn(d,c("paddingLeft"),A(!1)),sn(d,c("paddingRight"),A(!0)),M(!0)}function M(F){var G=Xt(u);(F||m.width!==G.width||m.height!==G.height)&&(sn(d,"height",w()),_(c("marginRight"),ci(t.gap)),_("width",D()),_("height",E(),!0),m=G,o(fa),f!==(f=W())&&(In(u,rh,f),o(cx,f)))}function A(F){var G=t.padding,I=c(F?"right":"left");return G&&ci(G[I]||(Or(G)?0:G))||"0px"}function w(){var F="";return g&&(F=y(),Dr(F,"height or heightRatio is missing."),F="calc("+F+" - "+A(!1)+" - "+A(!0)+")"),F}function y(){return ci(t.height||Xt(h).width*t.heightRatio)}function D(){return t.autoWidth?null:ci(t.fixedWidth)||(g?"":T())}function E(){return ci(t.fixedHeight)||(g?t.autoHeight?null:T():y())}function T(){var F=ci(t.gap);return"calc((100%"+(F&&" + "+F)+")/"+(t.perPage||1)+(F&&" - "+F)+")"}function U(){return Xt(h)[c("width")]}function k(F,G){var I=p(F||0);return I?Xt(I.slide)[c("width")]+(G?0:N()):0}function L(F,G){var I=p(F);if(I){var C=Xt(I.slide)[c("right")],V=Xt(h)[c("left")];return Ut(C-V)+(G?0:N())}return 0}function O(F){return L(i.length-1)-L(0)+k(0,F)}function N(){var F=p(0);return F&&parseFloat(sn(F.slide,c("marginRight")))||0}function J(F){return parseFloat(sn(d,c("padding"+(F?"Right":"Left"))))||0}function W(){return i.is(Qr)||O(!0)>U()}return{mount:x,resize:M,listSize:U,slideSize:k,sliderSize:O,totalSize:L,getPadding:J,isOverflow:W}}var Lx=2;function Px(i,e,t){var n=nt(i),r=n.on,s=e.Elements,o=e.Slides,a=e.Direction.resolve,c=[],l;function u(){r(ut,d),r([bt,fr],p),(l=m())&&(_(l),e.Layout.resize(!0))}function d(){h(),u()}function h(){Ei(c),Bn(c),n.destroy()}function p(){var f=m();l!==f&&(l<f||!f)&&n.emit(ut)}function _(f){var x=o.get().slice(),v=x.length;if(v){for(;x.length<f;)Os(x,x);Os(x.slice(-f),x.slice(0,f)).forEach(function(M,A){var w=A<f,y=g(M.slide,A);w?uc(y,x[0].slide):Kr(s.list,y),Os(c,y),o.register(y,A-f+(w?0:v),M.index)})}}function g(f,x){var v=f.cloneNode(!0);return vn(v,t.classes.clone),v.id=i.root.id+"-clone"+dc(x+1),v}function m(){var f=t.clones;if(!i.is(xr))f=0;else if($r(f)){var x=t[a("fixedWidth")]&&e.Layout.slideSize(0),v=x&&Hr(Xt(s.track)[a("width")]/x);f=v||t[a("autoWidth")]&&i.length||t.perPage*Lx}return f}return{mount:u,destroy:h}}function Dx(i,e,t){var n=nt(i),r=n.on,s=n.emit,o=i.state.set,a=e.Layout,c=a.slideSize,l=a.getPadding,u=a.totalSize,d=a.listSize,h=a.sliderSize,p=e.Direction,_=p.resolve,g=p.orient,m=e.Elements,f=m.list,x=m.track,v;function M(){v=e.Transition,r([ei,fa,bt,ut],A)}function A(){e.Controller.isBusy()||(e.Scroll.cancel(),y(i.index),e.Slides.update())}function w(I,C,V,Q){I!==C&&F(I>V)&&(U(),D(T(O(),I>V),!0)),o(vr),s(En,C,V,I),v.start(C,function(){o(ur),s(Si,C,V,I),Q&&Q()})}function y(I){D(L(I,!0))}function D(I,C){if(!i.is(Qr)){var V=C?I:E(I);sn(f,"transform","translate"+_("X")+"("+V+"px)"),I!==V&&s(qf)}}function E(I){if(i.is(xr)){var C=k(I),V=C>e.Controller.getEnd(),Q=C<0;(Q||V)&&(I=T(I,V))}return I}function T(I,C){var V=I-W(C),Q=h();return I-=g(Q*(Hr(Ut(V)/Q)||1))*(C?1:-1),I}function U(){D(O(),!0),v.cancel()}function k(I){for(var C=e.Slides.get(),V=0,Q=1/0,ee=0;ee<C.length;ee++){var ce=C[ee].index,j=Ut(L(ce,!0)-I);if(j<=Q)Q=j,V=ce;else break}return V}function L(I,C){var V=g(u(I-1)-J(I));return C?N(V):V}function O(){var I=_("left");return Xt(f)[I]-Xt(x)[I]+g(l(!1))}function N(I){return t.trimSpace&&i.is(hr)&&(I=Yi(I,0,g(h(!0)-d()))),I}function J(I){var C=t.focus;return C==="center"?(d()-c(I,!0))/2:+C*c(I)||0}function W(I){return L(I?e.Controller.getEnd():0,!!t.trimSpace)}function F(I){var C=g(T(O(),I));return I?C>=0:C<=f[_("scrollWidth")]-Xt(x)[_("width")]}function G(I,C){C=$r(C)?O():C;var V=I!==!0&&g(C)<g(W(!1)),Q=I!==!1&&g(C)>g(W(!0));return V||Q}return{mount:M,move:w,jump:y,translate:D,shift:T,cancel:U,toIndex:k,toPosition:L,getPosition:O,getLimit:W,exceededLimit:G,reposition:A}}function Ux(i,e,t){var n=nt(i),r=n.on,s=n.emit,o=e.Move,a=o.getPosition,c=o.getLimit,l=o.toPosition,u=e.Slides,d=u.isEnough,h=u.getLength,p=t.omitEnd,_=i.is(xr),g=i.is(hr),m=$e(O,!1),f=$e(O,!0),x=t.start||0,v,M=x,A,w,y;function D(){E(),r([bt,ut,js],E),r(fa,T)}function E(){A=h(!0),w=t.perMove,y=t.perPage,v=F();var j=Yi(x,0,p?v:A-1);j!==x&&(x=j,o.reposition())}function T(){v!==F()&&s(js)}function U(j,he,pe){if(!ce()){var Ee=L(j),Ve=W(Ee);Ve>-1&&(he||Ve!==x)&&(V(Ve),o.move(Ee,Ve,M,pe))}}function k(j,he,pe,Ee){e.Scroll.scroll(j,he,pe,function(){var Ve=W(o.toIndex(a()));V(p?Jn(Ve,v):Ve),Ee&&Ee()})}function L(j){var he=x;if(jn(j)){var pe=j.match(/([+\-<>])(\d+)?/)||[],Ee=pe[1],Ve=pe[2];Ee==="+"||Ee==="-"?he=N(x+ +(""+Ee+(+Ve||1)),x):Ee===">"?he=Ve?G(+Ve):m(!0):Ee==="<"&&(he=f(!0))}else he=_?j:Yi(j,0,v);return he}function O(j,he){var pe=w||(ee()?1:y),Ee=N(x+pe*(j?-1:1),x,!(w||ee()));return Ee===-1&&g&&!Gf(a(),c(!j),1)?j?0:v:he?Ee:W(Ee)}function N(j,he,pe){if(d()||ee()){var Ee=J(j);Ee!==j&&(he=j,j=Ee,pe=!1),j<0||j>v?!w&&(Fs(0,j,he,!0)||Fs(v,he,j,!0))?j=G(I(j)):_?j=pe?j<0?-(A%y||y):A:j:t.rewind?j=j<0?v:0:j=-1:pe&&j!==he&&(j=G(I(he)+(j<he?-1:1)))}else j=-1;return j}function J(j){if(g&&t.trimSpace==="move"&&j!==x)for(var he=a();he===l(j,!0)&&Fs(j,0,i.length-1,!t.rewind);)j<x?--j:++j;return j}function W(j){return _?(j+A)%A||0:j}function F(){for(var j=A-(ee()||_&&w?1:y);p&&j-- >0;)if(l(A-1,!0)!==l(j,!0)){j++;break}return Yi(j,0,A-1)}function G(j){return Yi(ee()?j:y*j,0,v)}function I(j){return ee()?Jn(j,v):$s((j>=v?A-1:j)/y)}function C(j){var he=o.toIndex(j);return g?Yi(he,0,v):he}function V(j){j!==x&&(M=x,x=j)}function Q(j){return j?M:x}function ee(){return!$r(t.focus)||t.isNavigation}function ce(){return i.state.is([vr,qr])&&!!t.waitForTransition}return{mount:D,go:U,scroll:k,getNext:m,getPrev:f,getAdjacent:O,getEnd:F,setIndex:V,getIndex:Q,toIndex:G,toPage:I,toDest:C,hasFocus:ee,isBusy:ce}}var Ix="http://www.w3.org/2000/svg",Nx="m15.5 0.932-4.3 4.38 14.5 14.6-14.5 14.5 4.3 4.4 14.6-14.6 4.4-4.3-4.4-4.4-14.6-14.6z",Cs=40;function Ox(i,e,t){var n=nt(i),r=n.on,s=n.bind,o=n.emit,a=t.classes,c=t.i18n,l=e.Elements,u=e.Controller,d=l.arrows,h=l.track,p=d,_=l.prev,g=l.next,m,f,x={};function v(){A(),r(bt,M)}function M(){w(),v()}function A(){var k=t.arrows;k&&!(_&&g)&&E(),_&&g&&(zr(x,{prev:_,next:g}),Gr(p,k?"":"none"),vn(p,f=Ec+"--"+t.direction),k&&(y(),U(),Le([_,g],Jr,h.id),o(No,_,g)))}function w(){n.destroy(),Nn(p,f),m?(Ei(d?[_,g]:p),_=g=null):xn([_,g],xc)}function y(){r([ei,Si,ut,wi,js],U),s(g,"click",$e(D,">")),s(_,"click",$e(D,"<"))}function D(k){u.go(k,!0)}function E(){p=d||tr("div",a.arrows),_=T(!0),g=T(!1),m=!0,Kr(p,[_,g]),!d&&uc(p,h)}function T(k){var L='<button class="'+a.arrow+" "+(k?a.prev:a.next)+'" type="button"><svg xmlns="'+Ix+'" viewBox="0 0 '+Cs+" "+Cs+'" width="'+Cs+'" height="'+Cs+'" focusable="false"><path d="'+(t.arrowPath||Nx)+'" />';return Bf(L)}function U(){if(_&&g){var k=i.index,L=u.getPrev(),O=u.getNext(),N=L>-1&&k<L?c.last:c.prev,J=O>-1&&k>O?c.first:c.next;_.disabled=L<0,g.disabled=O<0,Le(_,qt,N),Le(g,qt,J),o(Oo,_,g,L,O)}}return{arrows:x,mount:v,destroy:w,update:U}}var Fx=hc+"-interval";function Bx(i,e,t){var n=nt(i),r=n.on,s=n.bind,o=n.emit,a=da(t.interval,i.go.bind(i,">"),y),c=a.isPaused,l=e.Elements,u=e.Elements,d=u.root,h=u.toggle,p=t.autoplay,_,g,m=p==="pause";function f(){p&&(x(),h&&Le(h,Jr,l.track.id),m||v(),w())}function x(){t.pauseOnHover&&s(d,"mouseenter mouseleave",function(E){_=E.type==="mouseenter",A()}),t.pauseOnFocus&&s(d,"focusin focusout",function(E){g=E.type==="focusin",A()}),h&&s(h,"click",function(){m?v():M(!0)}),r([En,ha,ut],a.rewind),r(En,D)}function v(){c()&&e.Slides.isEnough()&&(a.start(!t.resetProgress),g=_=m=!1,w(),o(mc))}function M(E){E===void 0&&(E=!0),m=!!E,w(),c()||(a.pause(),o(_c))}function A(){m||(_||g?M(!1):v())}function w(){h&&(In(h,Mi,!m),Le(h,qt,t.i18n[m?"play":"pause"]))}function y(E){var T=l.bar;T&&sn(T,"width",E*100+"%"),o(zo,E)}function D(E){var T=e.Slides.getAt(E);a.set(T&&+cn(T.slide,Fx)||t.interval)}return{mount:f,destroy:a.cancel,play:v,pause:M,isPaused:c}}function zx(i,e,t){var n=nt(i),r=n.on;function s(){t.cover&&(r(Zs,$e(a,!0)),r([ei,bt,ut],$e(o,!0)))}function o(c){e.Slides.forEach(function(l){var u=Zr(l.container||l.slide,"img");u&&u.src&&a(c,u,l)})}function a(c,l,u){u.style("background",c?'center/cover no-repeat url("'+l.src+'")':"",!0),Gr(l,c?"none":"")}return{mount:s,destroy:$e(o,!1)}}var Gx=10,Hx=600,Vx=.6,kx=1.5,Wx=800;function Xx(i,e,t){var n=nt(i),r=n.on,s=n.emit,o=i.state.set,a=e.Move,c=a.getPosition,l=a.getLimit,u=a.exceededLimit,d=a.translate,h=i.is(hr),p,_,g=1;function m(){r(En,M),r([bt,ut],A)}function f(y,D,E,T,U){var k=c();if(M(),E&&(!h||!u())){var L=e.Layout.sliderSize(),O=Co(y)*L*$s(Ut(y)/L)||0;y=a.toPosition(e.Controller.toDest(y%L))+O}var N=Gf(k,y,1);g=1,D=N?0:D||qs(Ut(y-k)/kx,Wx),_=T,p=da(D,x,$e(v,k,y,U),1),o(qr),s(ha),p.start()}function x(){o(ur),_&&_(),s(wi)}function v(y,D,E,T){var U=c(),k=y+(D-y)*w(T),L=(k-U)*g;d(U+L),h&&!E&&u()&&(g*=Vx,Ut(L)<Gx&&f(l(u(!0)),Hx,!1,_,!0))}function M(){p&&p.cancel()}function A(){p&&!p.isPaused()&&(M(),x())}function w(y){var D=t.easingFunc;return D?D(y):1-Math.pow(1-y,4)}return{mount:m,destroy:M,scroll:f,cancel:A}}var Ki={passive:!1,capture:!0};function qx(i,e,t){var n=nt(i),r=n.on,s=n.emit,o=n.bind,a=n.unbind,c=i.state,l=e.Move,u=e.Scroll,d=e.Controller,h=e.Elements.track,p=e.Media.reduce,_=e.Direction,g=_.resolve,m=_.orient,f=l.getPosition,x=l.exceededLimit,v,M,A,w,y,D=!1,E,T,U;function k(){o(h,ao,wo,Ki),o(h,oo,wo,Ki),o(h,sh,O,Ki),o(h,"click",W,{capture:!0}),o(h,"dragstart",Ln),r([ei,bt],L)}function L(){var oe=t.drag;B(!oe),w=oe==="free"}function O(oe){if(E=!1,!T){var ue=Ve(oe);Ee(oe.target)&&(ue||!oe.button)&&(d.isBusy()?Ln(oe,!0):(U=ue?h:window,y=c.is([vr,qr]),A=null,o(U,ao,N,Ki),o(U,oo,J,Ki),l.cancel(),u.cancel(),F(oe)))}}function N(oe){if(c.is(Ns)||(c.set(Ns),s(Vf)),oe.cancelable)if(y){l.translate(v+pe(ee(oe)));var ue=ce(oe)>Ru,Te=D!==(D=x());(ue||Te)&&F(oe),E=!0,s(kf),Ln(oe)}else C(oe)&&(y=I(oe),Ln(oe))}function J(oe){c.is(Ns)&&(c.set(ur),s(Wf)),y&&(G(oe),Ln(oe)),a(U,ao,N),a(U,oo,J),y=!1}function W(oe){!T&&E&&Ln(oe,!0)}function F(oe){A=M,M=oe,v=f()}function G(oe){var ue=V(oe),Te=Q(ue),ye=t.rewind&&t.rewindByDrag;p(!1),w?d.scroll(Te,0,t.snap):i.is(Qr)?d.go(m(Co(ue))<0?ye?"<":"-":ye?">":"+"):i.is(hr)&&D&&ye?d.go(x(!0)?">":"<"):d.go(d.toDest(Te),!0),p(!0)}function I(oe){var ue=t.dragMinThreshold,Te=Or(ue),ye=Te&&ue.mouse||0,Ye=(Te?ue.touch:+ue)||10;return Ut(ee(oe))>(Ve(oe)?Ye:ye)}function C(oe){return Ut(ee(oe))>Ut(ee(oe,!0))}function V(oe){if(i.is(xr)||!D){var ue=ce(oe);if(ue&&ue<Ru)return ee(oe)/ue}return 0}function Q(oe){return f()+Co(oe)*Jn(Ut(oe)*(t.flickPower||600),w?1/0:e.Layout.listSize()*(t.flickMaxPages||1))}function ee(oe,ue){return he(oe,ue)-he(j(oe),ue)}function ce(oe){return Ro(oe)-Ro(j(oe))}function j(oe){return M===oe&&A||M}function he(oe,ue){return(Ve(oe)?oe.changedTouches[0]:oe)["page"+g(ue?"Y":"X")]}function pe(oe){return oe/(D&&i.is(hr)?Ax:1)}function Ee(oe){var ue=t.noDrag;return!Fr(oe,"."+eh+", ."+xa)&&(!ue||!Fr(oe,ue))}function Ve(oe){return typeof TouchEvent<"u"&&oe instanceof TouchEvent}function Pe(){return y}function B(oe){T=oe}return{mount:k,disable:B,isDragging:Pe}}var $x={Spacebar:" ",Right:_a,Left:ma,Up:$f,Down:Yf};function Sc(i){return i=jn(i)?i:i.key,$x[i]||i}var Cu="keydown";function Yx(i,e,t){var n=nt(i),r=n.on,s=n.bind,o=n.unbind,a=i.root,c=e.Direction.resolve,l,u;function d(){h(),r(bt,p),r(bt,h),r(En,g)}function h(){var f=t.keyboard;f&&(l=f==="global"?window:a,s(l,Cu,m))}function p(){o(l,Cu)}function _(f){u=f}function g(){var f=u;u=!0,Uf(function(){u=f})}function m(f){if(!u){var x=Sc(f);x===c(ma)?i.go("<"):x===c(_a)&&i.go(">")}}return{mount:d,destroy:p,disable:_}}var Ur=hc+"-lazy",Bs=Ur+"-srcset",Kx="["+Ur+"], ["+Bs+"]";function Zx(i,e,t){var n=nt(i),r=n.on,s=n.off,o=n.bind,a=n.emit,c=t.lazyLoad==="sequential",l=[Si,wi],u=[];function d(){t.lazyLoad&&(h(),r(ut,h))}function h(){Bn(u),p(),c?f():(s(l),r(l,_),_())}function p(){e.Slides.forEach(function(x){fc(x.slide,Kx).forEach(function(v){var M=cn(v,Ur),A=cn(v,Bs);if(M!==v.src||A!==v.srcset){var w=t.classes.spinner,y=v.parentElement,D=Zr(y,"."+w)||tr("span",w,y);u.push([v,x,D]),v.src||Gr(v,"none")}})})}function _(){u=u.filter(function(x){var v=t.perPage*((t.preloadPages||1)+1)-1;return x[1].isWithin(i.index,v)?g(x):!0}),u.length||s(l)}function g(x){var v=x[0];vn(x[1].slide,Ho),o(v,"load error",$e(m,x)),Le(v,"src",cn(v,Ur)),Le(v,"srcset",cn(v,Bs)),xn(v,Ur),xn(v,Bs)}function m(x,v){var M=x[0],A=x[1];Nn(A.slide,Ho),v.type!=="error"&&(Ei(x[2]),Gr(M,""),a(Zs,M,A),a(fr)),c&&f()}function f(){u.length&&g(u.shift())}return{mount:d,destroy:$e(Bn,u),check:_}}function jx(i,e,t){var n=nt(i),r=n.on,s=n.emit,o=n.bind,a=e.Slides,c=e.Elements,l=e.Controller,u=l.hasFocus,d=l.getIndex,h=l.go,p=e.Direction.resolve,_=c.pagination,g=[],m,f;function x(){v(),r([bt,ut,js],x);var T=t.pagination;_&&Gr(_,T?"":"none"),T&&(r([En,ha,wi],E),M(),E(),s(Fo,{list:m,items:g},D(i.index)))}function v(){m&&(Ei(_?Qn(m.children):m),Nn(m,f),Bn(g),m=null),n.destroy()}function M(){var T=i.length,U=t.classes,k=t.i18n,L=t.perPage,O=u()?l.getEnd()+1:Hr(T/L);m=_||tr("ul",U.pagination,c.track.parentElement),vn(m,f=Ea+"--"+y()),Le(m,On,"tablist"),Le(m,qt,k.select),Le(m,vc,y()===ga?"vertical":"");for(var N=0;N<O;N++){var J=tr("li",null,m),W=tr("button",{class:U.page,type:"button"},J),F=a.getIn(N).map(function(I){return I.slide.id}),G=!u()&&L>1?k.pageX:k.slideX;o(W,"click",$e(A,N)),t.paginationKeyboard&&o(W,"keydown",$e(w,N)),Le(J,On,"presentation"),Le(W,On,"tab"),Le(W,Jr,F.join(" ")),Le(W,qt,Lo(G,N+1)),Le(W,nr,-1),g.push({li:J,button:W,page:N})}}function A(T){h(">"+T,!0)}function w(T,U){var k=g.length,L=Sc(U),O=y(),N=-1;L===p(_a,!1,O)?N=++T%k:L===p(ma,!1,O)?N=(--T+k)%k:L==="Home"?N=0:L==="End"&&(N=k-1);var J=g[N];J&&(Ff(J.button),h(">"+N),Ln(U,!0))}function y(){return t.paginationDirection||t.direction}function D(T){return g[l.toPage(T)]}function E(){var T=D(d(!0)),U=D(d());if(T){var k=T.button;Nn(k,Mi),xn(k,yu),Le(k,nr,-1)}if(U){var L=U.button;vn(L,Mi),Le(L,yu,!0),Le(L,nr,"")}s(Bo,{list:m,items:g},T,U)}return{items:g,mount:x,destroy:v,getAt:D,update:E}}var Jx=[" ","Enter"];function Qx(i,e,t){var n=t.isNavigation,r=t.slideFocus,s=[];function o(){i.splides.forEach(function(_){_.isParent||(l(i,_.splide),l(_.splide,i))}),n&&u()}function a(){s.forEach(function(_){_.destroy()}),Bn(s)}function c(){a(),o()}function l(_,g){var m=nt(_);m.on(En,function(f,x,v){g.go(g.is(xr)?v:f)}),s.push(m)}function u(){var _=nt(i),g=_.on;g(Ys,h),g(Xf,p),g([ei,bt],d),s.push(_),_.emit(Ks,i.splides)}function d(){Le(e.Elements.list,vc,t.direction===ga?"vertical":"")}function h(_){i.go(_.index)}function p(_,g){lc(Jx,Sc(g))&&(h(_),Ln(g))}return{setup:$e(e.Media.set,{slideFocus:$r(r)?n:r},!0),mount:o,destroy:a,remount:c}}function eE(i,e,t){var n=nt(i),r=n.bind,s=0;function o(){t.wheel&&r(e.Elements.track,"wheel",a,Ki)}function a(l){if(l.cancelable){var u=l.deltaY,d=u<0,h=Ro(l),p=t.wheelMinThreshold||0,_=t.wheelSleep||0;Ut(u)>p&&h-s>_&&(i.go(d?"<":">"),s=h),c(d)&&Ln(l)}}function c(l){return!t.releaseWheel||i.state.is(vr)||e.Controller.getAdjacent(l)!==-1}return{mount:o}}var tE=90;function nE(i,e,t){var n=nt(i),r=n.on,s=e.Elements.track,o=t.live&&!t.isNavigation,a=tr("span",Ex),c=da(tE,$e(u,!1));function l(){o&&(h(!e.Autoplay.isPaused()),Le(s,bu,!0),a.textContent="…",r(mc,$e(h,!0)),r(_c,$e(h,!1)),r([Si,wi],$e(u,!0)))}function u(p){Le(s,Au,p),p?(Kr(s,a),c.start()):(Ei(a),c.cancel())}function d(){xn(s,[Tu,bu,Au]),Ei(a)}function h(p){o&&Le(s,Tu,p?"off":"polite")}return{mount:l,disable:h,destroy:d}}var iE=Object.freeze({__proto__:null,Media:fx,Direction:hx,Elements:bx,Slides:Rx,Layout:Cx,Clones:Px,Move:Dx,Controller:Ux,Arrows:Ox,Autoplay:Bx,Cover:zx,Scroll:Xx,Drag:qx,Keyboard:Yx,LazyLoad:Zx,Pagination:jx,Sync:Qx,Wheel:eE,Live:nE}),rE={prev:"Previous slide",next:"Next slide",first:"Go to first slide",last:"Go to last slide",slideX:"Go to slide %s",pageX:"Go to page %s",play:"Start autoplay",pause:"Pause autoplay",carousel:"carousel",slide:"slide",select:"Select a slide to show",slideLabel:"%s of %s"},sE={type:"slide",role:"region",speed:400,perPage:1,cloneStatus:!0,arrows:!0,pagination:!0,paginationKeyboard:!0,interval:5e3,pauseOnHover:!0,pauseOnFocus:!0,resetProgress:!0,easing:"cubic-bezier(0.25, 1, 0.5, 1)",drag:!0,direction:"ltr",trimSpace:!0,focusableNodes:"a, button, textarea, input, select, iframe",live:!0,classes:yx,i18n:rE,reducedMotion:{speed:0,rewindSpeed:0,autoplay:"pause"}};function aE(i,e,t){var n=e.Slides;function r(){nt(i).on([ei,ut],s)}function s(){n.forEach(function(a){a.style("transform","translateX(-"+100*a.index+"%)")})}function o(a,c){n.style("transition","opacity "+t.speed+"ms "+t.easing),Uf(c)}return{mount:r,start:o,cancel:wo}}function oE(i,e,t){var n=e.Move,r=e.Controller,s=e.Scroll,o=e.Elements.list,a=$e(sn,o,"transition"),c;function l(){nt(i).bind(o,"transitionend",function(p){p.target===o&&c&&(d(),c())})}function u(p,_){var g=n.toPosition(p,!0),m=n.getPosition(),f=h(p);Ut(g-m)>=1&&f>=1?t.useScroll?s.scroll(g,f,!1,_):(a("transform "+f+"ms "+t.easing),n.translate(g,!0),c=_):(n.jump(p),_())}function d(){a(""),s.cancel()}function h(p){var _=t.rewindSpeed;if(i.is(hr)&&_){var g=r.getIndex(!0),m=r.getEnd();if(g===0&&p>=m||g>=m&&p===0)return _}return t.speed}return{mount:l,start:u,cancel:d}}var cE=function(){function i(t,n){this.event=nt(),this.Components={},this.state=lx(ji),this.splides=[],this._o={},this._E={};var r=jn(t)?zf(document,t):t;Dr(r,r+" is invalid."),this.root=r,n=qn({label:cn(r,qt)||"",labelledby:cn(r,gc)||""},sE,i.defaults,n||{});try{qn(n,JSON.parse(cn(r,hc)))}catch{Dr(!1,"Invalid JSON")}this._o=Object.create(qn({},n))}var e=i.prototype;return e.mount=function(n,r){var s=this,o=this.state,a=this.Components;Dr(o.is([ji,Xs]),"Already mounted!"),o.set(ji),this._C=a,this._T=r||this._T||(this.is(Qr)?aE:oE),this._E=n||this._E;var c=zr({},iE,this._E,{Transition:this._T});return gi(c,function(l,u){var d=l(s,a,s._o);a[u]=d,d.setup&&d.setup()}),gi(a,function(l){l.mount&&l.mount()}),this.emit(ei),vn(this.root,Sx),o.set(ur),this.emit(Su),this},e.sync=function(n){return this.splides.push({splide:n}),n.splides.push({splide:this,isParent:!0}),this.state.is(ur)&&(this._C.Sync.remount(),n.Components.Sync.remount()),this},e.go=function(n){return this._C.Controller.go(n),this},e.on=function(n,r){return this.event.on(n,r),this},e.off=function(n){return this.event.off(n),this},e.emit=function(n){var r;return(r=this.event).emit.apply(r,[n].concat(Qn(arguments,1))),this},e.add=function(n,r){return this._C.Slides.add(n,r),this},e.remove=function(n){return this._C.Slides.remove(n),this},e.is=function(n){return this._o.type===n},e.refresh=function(){return this.emit(ut),this},e.destroy=function(n){n===void 0&&(n=!0);var r=this.event,s=this.state;return s.is(ji)?nt(this).on(Su,this.destroy.bind(this,n)):(gi(this._C,function(o){o.destroy&&o.destroy(n)},!0),r.emit(pc),r.destroy(),n&&Bn(this.splides),s.set(Xs)),this},rx(i,[{key:"options",get:function(){return this._o},set:function(n){this._C.Media.set(n,!0,!0)}},{key:"length",get:function(){return this._C.Slides.getLength(!0)}},{key:"index",get:function(){return this._C.Controller.getIndex()}}]),i}(),Mc=cE;Mc.defaults={};Mc.STATES=ax;const lE=[ei,ut,fr,fa,Vf,kf,Wf,ha,wi,pc,mc,_c];function uE(i,e){const t=(n,r={})=>{e(fE(n),{splide:i,...r})};i.on(Ys,(n,r)=>{t(Ys,{Slide:n,e:r})}),i.on(En,(n,r,s)=>{t(En,{index:n,prev:r,dest:s})}),i.on(Si,(n,r,s)=>{t(Si,{index:n,prev:r,dest:s})}),i.on(Po,n=>{t(Po,{Slide:n})}),i.on(Do,n=>{t(Do,{Slide:n})}),i.on(Uo,n=>{t(Uo,{Slide:n})}),i.on(Io,n=>{t(Io,{Slide:n})}),i.on(bt,n=>{t(bt,n)}),i.on(No,(n,r)=>{t(No,{prev:n,next:r})}),i.on(Oo,(n,r)=>{t(Oo,{prev:n,next:r})}),i.on(Fo,(n,r)=>{t(Fo,{data:n,item:r})}),i.on(Bo,(n,r,s)=>{t(Bo,{data:n,prev:r,curr:s})}),i.on(Ks,n=>{t(Ks,{splides:n})}),i.on(zo,n=>{t(zo,{rate:n})}),i.on(Zs,(n,r)=>{t(Zs,{img:n,Slide:r})}),lE.forEach(n=>{i.on(n,()=>{t(n)})})}function fE(i){return i.split(":").map((e,t)=>t>0?e.charAt(0).toUpperCase()+e.slice(1):e).join("").replace("Lazyload","LazyLoad")}function hE(i){let e;const t=i[11].default,n=Js(t,i,i[13],null);return{c(){n&&n.c()},l(r){n&&n.l(r)},m(r,s){n&&n.m(r,s),e=!0},p(r,s){n&&n.p&&(!e||s&8192)&&Qs(n,t,r,r[13],e?ta(t,r[13],s,null):ea(r[13]),null)},i(r){e||(xt(n,r),e=!0)},o(r){vt(n,r),e=!1},d(r){n&&n.d(r)}}}function dE(i){let e,t;return e=new EE({props:{$$slots:{default:[pE]},$$scope:{ctx:i}}}),{c(){Qt(e.$$.fragment)},l(n){en(e.$$.fragment,n)},m(n,r){tn(e,n,r),t=!0},p(n,r){const s={};r&8192&&(s.$$scope={dirty:r,ctx:n}),e.$set(s)},i(n){t||(xt(e.$$.fragment,n),t=!0)},o(n){vt(e.$$.fragment,n),t=!1},d(n){nn(e,n)}}}function pE(i){let e;const t=i[11].default,n=Js(t,i,i[13],null);return{c(){n&&n.c()},l(r){n&&n.l(r)},m(r,s){n&&n.m(r,s),e=!0},p(r,s){n&&n.p&&(!e||s&8192)&&Qs(n,t,r,r[13],e?ta(t,r[13],s,null):ea(r[13]),null)},i(r){e||(xt(n,r),e=!0)},o(r){vt(n,r),e=!1},d(r){n&&n.d(r)}}}function mE(i){let e,t,n,r,s;const o=[dE,hE],a=[];function c(d,h){return d[1]?0:1}t=c(i),n=a[t]=o[t](i);let l=[{class:r=lr("splide",i[0])},i[3]],u={};for(let d=0;d<l.length;d+=1)u=Fn(u,l[d]);return{c(){e=Ze("div"),n.c(),this.h()},l(d){e=je(d,"DIV",{class:!0});var h=At(e);n.l(h),h.forEach(be),this.h()},h(){ir(e,u)},m(d,h){ke(d,e,h),a[t].m(e,null),i[12](e),s=!0},p(d,[h]){let p=t;t=c(d),t===p?a[t].p(d,h):(ph(),vt(a[p],1,1,()=>{a[p]=null}),mh(),n=a[t],n?n.p(d,h):(n=a[t]=o[t](d),n.c()),xt(n,1),n.m(e,null)),ir(e,u=ko(l,[(!s||h&1&&r!==(r=lr("splide",d[0])))&&{class:r},h&8&&d[3]]))},i(d){s||(xt(n),s=!0)},o(d){vt(n),s=!1},d(d){d&&be(e),a[t].d(),i[12](null)}}}function _E(i,e,t){const n=["class","options","splide","extensions","transition","hasTrack","go","sync"];let r=rr(e,n),{$$slots:s={},$$scope:o}=e,{class:a=void 0}=e,{options:c={}}=e,{splide:l=void 0}=e,{extensions:u=void 0}=e,{transition:d=void 0}=e,{hasTrack:h=!0}=e;const p=_h();let _,g,m=bo({},c);Vo(()=>(t(4,l=new Mc(_,c)),uE(l,p),l.mount(u,d),g=pu(l),()=>l.destroy())),gh(()=>{if(l){const M=pu(l);ix(g,M)||(l.refresh(),g=M.slice())}});function f(M){l==null||l.go(M)}function x(M){l==null||l.sync(M)}function v(M){Pu[M?"unshift":"push"](()=>{_=M,t(2,_)})}return i.$$set=M=>{e=Fn(Fn({},e),Wo(M)),t(3,r=rr(e,n)),"class"in M&&t(0,a=M.class),"options"in M&&t(5,c=M.options),"splide"in M&&t(4,l=M.splide),"extensions"in M&&t(6,u=M.extensions),"transition"in M&&t(7,d=M.transition),"hasTrack"in M&&t(1,h=M.hasTrack),"$$scope"in M&&t(13,o=M.$$scope)},i.$$.update=()=>{i.$$.dirty&1072&&l&&!Ao(m,c)&&(t(4,l.options=c,l),t(10,m=bo({},m)))},[a,h,_,r,l,c,u,d,f,x,m,s,v,o]}class gE extends yi{constructor(e){super(),Ti(this,e,_E,mE,Ai,{class:0,options:5,splide:4,extensions:6,transition:7,hasTrack:1,go:8,sync:9})}get class(){return this.$$.ctx[0]}set class(e){this.$$set({class:e}),Ri()}get options(){return this.$$.ctx[5]}set options(e){this.$$set({options:e}),Ri()}get splide(){return this.$$.ctx[4]}set splide(e){this.$$set({splide:e}),Ri()}get extensions(){return this.$$.ctx[6]}set extensions(e){this.$$set({extensions:e}),Ri()}get transition(){return this.$$.ctx[7]}set transition(e){this.$$set({transition:e}),Ri()}get hasTrack(){return this.$$.ctx[1]}set hasTrack(e){this.$$set({hasTrack:e}),Ri()}get go(){return this.$$.ctx[8]}get sync(){return this.$$.ctx[9]}}function vE(i){let e,t,n,r;const s=i[3].default,o=Js(s,i,i[2],null);let a=[{class:n=lr("splide__track",i[0])},i[1]],c={};for(let l=0;l<a.length;l+=1)c=Fn(c,a[l]);return{c(){e=Ze("div"),t=Ze("ul"),o&&o.c(),this.h()},l(l){e=je(l,"DIV",{class:!0});var u=At(e);t=je(u,"UL",{class:!0});var d=At(t);o&&o.l(d),d.forEach(be),u.forEach(be),this.h()},h(){we(t,"class","splide__list"),ir(e,c)},m(l,u){ke(l,e,u),Qe(e,t),o&&o.m(t,null),r=!0},p(l,[u]){o&&o.p&&(!r||u&4)&&Qs(o,s,l,l[2],r?ta(s,l[2],u,null):ea(l[2]),null),ir(e,c=ko(a,[(!r||u&1&&n!==(n=lr("splide__track",l[0])))&&{class:n},u&2&&l[1]]))},i(l){r||(xt(o,l),r=!0)},o(l){vt(o,l),r=!1},d(l){l&&be(e),o&&o.d(l)}}}function xE(i,e,t){const n=["class"];let r=rr(e,n),{$$slots:s={},$$scope:o}=e,{class:a=void 0}=e;return i.$$set=c=>{e=Fn(Fn({},e),Wo(c)),t(1,r=rr(e,n)),"class"in c&&t(0,a=c.class),"$$scope"in c&&t(2,o=c.$$scope)},[a,r,o,s]}class EE extends yi{constructor(e){super(),Ti(this,e,xE,vE,Ai,{class:0})}}function SE(i){let e,t,n;const r=i[3].default,s=Js(r,i,i[2],null);let o=[{class:t=lr("splide__slide",i[0])},i[1]],a={};for(let c=0;c<o.length;c+=1)a=Fn(a,o[c]);return{c(){e=Ze("li"),s&&s.c(),this.h()},l(c){e=je(c,"LI",{class:!0});var l=At(e);s&&s.l(l),l.forEach(be),this.h()},h(){ir(e,a)},m(c,l){ke(c,e,l),s&&s.m(e,null),n=!0},p(c,[l]){s&&s.p&&(!n||l&4)&&Qs(s,r,c,c[2],n?ta(r,c[2],l,null):ea(c[2]),null),ir(e,a=ko(o,[(!n||l&1&&t!==(t=lr("splide__slide",c[0])))&&{class:t},l&2&&c[1]]))},i(c){n||(xt(s,c),n=!0)},o(c){vt(s,c),n=!1},d(c){c&&be(e),s&&s.d(c)}}}function ME(i,e,t){const n=["class"];let r=rr(e,n),{$$slots:s={},$$scope:o}=e,{class:a=void 0}=e;return i.$$set=c=>{e=Fn(Fn({},e),Wo(c)),t(1,r=rr(e,n)),"class"in c&&t(0,a=c.class),"$$scope"in c&&t(2,o=c.$$scope)},[a,r,o,s]}class Xi extends yi{constructor(e){super(),Ti(this,e,ME,SE,Ai,{class:0})}}const Er=""+new URL("../assets/github.1ea8d62e.svg",import.meta.url).href;function yE(i){let e,t;return{c(){e=Ze("img"),this.h()},l(n){e=je(n,"IMG",{src:!0,alt:!0,class:!0,width:!0,height:!0}),this.h()},h(){dr(e.src,t=Er)||we(e,"src",t),we(e,"alt","Logo GitHub"),we(e,"class","imgcarousel"),we(e,"width","50"),we(e,"height","50")},m(n,r){ke(n,e,r)},p:ln,d(n){n&&be(e)}}}function TE(i){let e,t;return{c(){e=Ze("img"),this.h()},l(n){e=je(n,"IMG",{src:!0,alt:!0,class:!0,width:!0,height:!0}),this.h()},h(){dr(e.src,t=Er)||we(e,"src",t),we(e,"alt","Logo GitHub"),we(e,"class","imgcarousel"),we(e,"width","50"),we(e,"height","50")},m(n,r){ke(n,e,r)},p:ln,d(n){n&&be(e)}}}function AE(i){let e,t;return{c(){e=Ze("img"),this.h()},l(n){e=je(n,"IMG",{src:!0,alt:!0,class:!0,width:!0,height:!0}),this.h()},h(){dr(e.src,t=Er)||we(e,"src",t),we(e,"alt","Logo GitHub"),we(e,"class","imgcarousel"),we(e,"width","50"),we(e,"height","50")},m(n,r){ke(n,e,r)},p:ln,d(n){n&&be(e)}}}function bE(i){let e,t;return{c(){e=Ze("img"),this.h()},l(n){e=je(n,"IMG",{src:!0,alt:!0,class:!0,width:!0,height:!0}),this.h()},h(){dr(e.src,t=Er)||we(e,"src",t),we(e,"alt","Logo GitHub"),we(e,"class","imgcarousel"),we(e,"width","50"),we(e,"height","50")},m(n,r){ke(n,e,r)},p:ln,d(n){n&&be(e)}}}function wE(i){let e,t;return{c(){e=Ze("img"),this.h()},l(n){e=je(n,"IMG",{src:!0,alt:!0,class:!0,width:!0,height:!0}),this.h()},h(){dr(e.src,t=Er)||we(e,"src",t),we(e,"alt","Logo GitHub"),we(e,"class","imgcarousel"),we(e,"width","50"),we(e,"height","50")},m(n,r){ke(n,e,r)},p:ln,d(n){n&&be(e)}}}function RE(i){let e,t;return{c(){e=Ze("img"),this.h()},l(n){e=je(n,"IMG",{src:!0,alt:!0,class:!0,width:!0,height:!0}),this.h()},h(){dr(e.src,t=Er)||we(e,"src",t),we(e,"alt","Logo GitHub"),we(e,"class","imgcarousel"),we(e,"width","50"),we(e,"height","50")},m(n,r){ke(n,e,r)},p:ln,d(n){n&&be(e)}}}function CE(i){let e,t,n,r,s,o,a,c,l,u,d,h;return e=new Xi({props:{$$slots:{default:[yE]},$$scope:{ctx:i}}}),n=new Xi({props:{$$slots:{default:[TE]},$$scope:{ctx:i}}}),s=new Xi({props:{$$slots:{default:[AE]},$$scope:{ctx:i}}}),a=new Xi({props:{$$slots:{default:[bE]},$$scope:{ctx:i}}}),l=new Xi({props:{$$slots:{default:[wE]},$$scope:{ctx:i}}}),d=new Xi({props:{$$slots:{default:[RE]},$$scope:{ctx:i}}}),{c(){Qt(e.$$.fragment),t=_t(),Qt(n.$$.fragment),r=_t(),Qt(s.$$.fragment),o=_t(),Qt(a.$$.fragment),c=_t(),Qt(l.$$.fragment),u=_t(),Qt(d.$$.fragment)},l(p){en(e.$$.fragment,p),t=gt(p),en(n.$$.fragment,p),r=gt(p),en(s.$$.fragment,p),o=gt(p),en(a.$$.fragment,p),c=gt(p),en(l.$$.fragment,p),u=gt(p),en(d.$$.fragment,p)},m(p,_){tn(e,p,_),ke(p,t,_),tn(n,p,_),ke(p,r,_),tn(s,p,_),ke(p,o,_),tn(a,p,_),ke(p,c,_),tn(l,p,_),ke(p,u,_),tn(d,p,_),h=!0},p(p,_){const g={};_&2&&(g.$$scope={dirty:_,ctx:p}),e.$set(g);const m={};_&2&&(m.$$scope={dirty:_,ctx:p}),n.$set(m);const f={};_&2&&(f.$$scope={dirty:_,ctx:p}),s.$set(f);const x={};_&2&&(x.$$scope={dirty:_,ctx:p}),a.$set(x);const v={};_&2&&(v.$$scope={dirty:_,ctx:p}),l.$set(v);const M={};_&2&&(M.$$scope={dirty:_,ctx:p}),d.$set(M)},i(p){h||(xt(e.$$.fragment,p),xt(n.$$.fragment,p),xt(s.$$.fragment,p),xt(a.$$.fragment,p),xt(l.$$.fragment,p),xt(d.$$.fragment,p),h=!0)},o(p){vt(e.$$.fragment,p),vt(n.$$.fragment,p),vt(s.$$.fragment,p),vt(a.$$.fragment,p),vt(l.$$.fragment,p),vt(d.$$.fragment,p),h=!1},d(p){nn(e,p),p&&be(t),nn(n,p),p&&be(r),nn(s,p),p&&be(o),nn(a,p),p&&be(c),nn(l,p),p&&be(u),nn(d,p)}}}function LE(i){let e,t;return e=new gE({props:{options:i[0],extensions:{AutoScroll:tx},"aria-label":"My Favorite Images",$$slots:{default:[CE]},$$scope:{ctx:i}}}),{c(){Qt(e.$$.fragment)},l(n){en(e.$$.fragment,n)},m(n,r){tn(e,n,r),t=!0},p(n,[r]){const s={};r&2&&(s.$$scope={dirty:r,ctx:n}),e.$set(s)},i(n){t||(xt(e.$$.fragment,n),t=!0)},o(n){vt(e.$$.fragment,n),t=!1},d(n){nn(e,n)}}}function PE(i){return[{type:"loop",gap:"10px",drag:"free",arrows:!1,pagination:!1,perPage:3,autoScroll:{pauseOnHover:!0,pauseOnFocus:!0,rewind:!1,speed:1}}]}class DE extends yi{constructor(e){super(),Ti(this,e,PE,LE,Ai,{})}}function UE(i){let e,t,n,r=i[0]("home.title")+"",s,o,a,c=i[0]("home.text",{link:Lu})+"",l,u,d=i[0]("home.link")+"",h,p,_,g,m,f,x,v,M,A;return _=new Ov({}),m=new P0({}),x=new DE({}),{c(){e=Ze("meta"),t=_t(),n=Ze("h1"),s=dn(r),o=_t(),a=Ze("p"),l=_t(),u=Ze("a"),h=dn(d),p=_t(),Qt(_.$$.fragment),g=_t(),Qt(m.$$.fragment),f=_t(),Qt(x.$$.fragment),this.h()},l(w){const y=vh("svelte-1nt1ujr",document.head);e=je(y,"META",{name:!0,content:!0}),y.forEach(be),t=gt(w),n=je(w,"H1",{});var D=At(n);s=pn(D,r),D.forEach(be),o=gt(w),a=je(w,"P",{});var E=At(a);E.forEach(be),l=gt(w),u=je(w,"A",{href:!0});var T=At(u);h=pn(T,d),T.forEach(be),p=gt(w),en(_.$$.fragment,w),g=gt(w),en(m.$$.fragment,w),f=gt(w),en(x.$$.fragment,w),this.h()},h(){document.title="Page d'exemple",we(e,"name","description"),we(e,"content","Ceci est une description de la page d'exemple."),we(u,"href","/about")},m(w,y){Qe(document.head,e),ke(w,t,y),ke(w,n,y),Qe(n,s),ke(w,o,y),ke(w,a,y),a.innerHTML=c,ke(w,l,y),ke(w,u,y),Qe(u,h),ke(w,p,y),tn(_,w,y),ke(w,g,y),tn(m,w,y),ke(w,f,y),tn(x,w,y),v=!0,M||(A=xh(Eh.call(null,u,"first")),M=!0)},p(w,[y]){(!v||y&1)&&r!==(r=w[0]("home.title")+"")&&zs(s,r),(!v||y&1)&&c!==(c=w[0]("home.text",{link:Lu})+"")&&(a.innerHTML=c),(!v||y&1)&&d!==(d=w[0]("home.link")+"")&&zs(h,d)},i(w){v||(xt(_.$$.fragment,w),xt(m.$$.fragment,w),xt(x.$$.fragment,w),v=!0)},o(w){vt(_.$$.fragment,w),vt(m.$$.fragment,w),vt(x.$$.fragment,w),v=!1},d(w){be(e),w&&be(t),w&&be(n),w&&be(o),w&&be(a),w&&be(l),w&&be(u),w&&be(p),nn(_,w),w&&be(g),nn(m,w),w&&be(f),nn(x,w),M=!1,A()}}}const Lu="https://kit.svelte.dev";function IE(i,e,t){let n;return Uu(i,Iu,r=>t(0,n=r)),[n]}class kE extends yi{constructor(e){super(),Ti(this,e,IE,UE,Ai,{})}}export{kE as component,zE as universal};
